...
class $eda442ba39f881a8$var$Tab extends EventTarget {
    ...
    setIcon(iconURL, icon) {
        ...
        // Validiere iconURL - nur gültige URLs erlauben, NICHT single-char Strings wie "x"
        const isValidURL = iconURL && typeof iconURL === 'string' && (
            iconURL.startsWith('http://') ||
            iconURL.startsWith('https://') ||
            iconURL.startsWith('data:') ||
            iconURL.startsWith('file://') ||
            iconURL.startsWith('/') ||
            iconURL.length > 1  // Blockiere single-character URLs
        );
